...
const Navbar: FC<NavbarProps> = ({ toggleTheme, theme }) => {
  ...
  const styles = {
    ...
    dropdown: isNight
      ? "bg-[#0A1929] border border-white/10"
      : "bg-white border border-slate-200",
  };

  return (
    <div
      className={`navbar ${styles.glass} sticky top-0 px-6 h-20 items-center z-[100] transition-all duration-300`}
    >
      <div className="navbar-start flex items-center gap-4">
        ...
        >
          ...
          <div className="hidden md:flex flex-col items-start leading-none border-l border-white/10 pl-3">
            <span
              className={`text-[11px] font-black tracking-widest ${styles.text}`}
            >
              SIM_PKL
            </span>
            <span
              className={`text-[8px] font-mono opacity-40 uppercase ${styles.text}`}
            >
              Industrial_System
            </span>
          </div>
      ...
      <div className="navbar-end gap-6">
        ...
        <div className="flex items-center gap-3 px-3 py-1.5 rounded-lg bg-black/10 dark:bg-white/5 border border-white/5">
          <CiSun
            className={`${!isNight ? styles.accent : "opacity-20"} text-xl`}
          />
          <input
            type="checkbox"
          ...
          />
          <FaMoon
            className={`${isNight ? styles.accent : "opacity-20"} text-sm`}
          />
        </div>
        ...
        <div className="dropdown dropdown-end">
          ...
          >
            ...
            <div
              className={`w-10 h-10 rounded-lg border ${isNight ? "border-white/10" : "border-slate-300"} overflow-hidden`}
            >
              <img
                alt="Profile"
                src={
          ...
          >
            <li>
              <a
                ...
                className="flex items-center gap-3 py-3 hover:bg-white/5 rounded-lg transition-all"
              >
            ...
            <li>
              <a
                ...
                className="flex items-center gap-3 py-3 text-red-500 hover:bg-red-500/5 rounded-lg transition-all"
              >
