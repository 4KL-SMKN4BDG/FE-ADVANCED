...
>
<img src="/src/assets/logosmkn4.png" alt="Logo" className="h-10 w-auto opacity-90" />
</motion.div>
...
<label className="text-sm font-medium text-slate-300">ID Number (NIS/NIP)</label>
<input 
type="text"
...
/>
{errors.nomorInduk && (
<span className="text-xs text-red-500 font-medium">{errors.nomorInduk.message}</span>
)}
</div>
