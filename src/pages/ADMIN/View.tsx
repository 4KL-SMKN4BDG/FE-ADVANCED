...
<div className="mb-8">
<h1 className="text-3xl font-bold tracking-tight mb-2">Review Registration</h1>
...
>
<div className={`grid grid-cols-[50px_1fr_1fr_100px_80px] gap-4 px-6 py-3 text-xs font-semibold ${isNight ? 'bg-[#1a1a1a] border-b border-white/10' : 'bg-slate-50 border-b border-slate-200'} ${styles.textSub}`}>
<div>#</div>
<div>Full Name</div>
<div>ID Number</div>
<div>Role</div>
...
<div>
<span className={`px-2 py-1 rounded text-xs font-medium ${isNight ? 'bg-blue-500/10 text-blue-400' : 'bg-blue-50 text-blue-600'}`}>
{reviewData.role}
</span>
</div>
<div>
