      ...
      <div className="max-w-5xl mx-auto px-6 pt-12">
        ...
        <div className="mb-8">
          <h1 className="text-3xl font-bold tracking-tight mb-2">
            {idCompany ? "Edit Company" : "Add Company"}
          </h1>
            ...
            {listPerusahaan.map((item, index) => (
              ...
              >
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div
                    className={`relative w-full aspect-square rounded-xl border-2 border-dashed ${styles.input} flex items-center justify-center overflow-hidden hover:border-blue-500 transition-colors`}
                  >
                    {item.preview ? (
                      <img
                        src={item.preview}
                ...
                <div className="grid grid-cols-1 gap-4">
                  ...
                  <div className="flex flex-col gap-1.5">
                    ...
                    <textarea
                      ...
                      className={`w-full p-2.5 text-sm rounded-lg border ${styles.input} outline-none h-24 resize-none`}
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="flex flex-col gap-1.5">
                      <label className="text-sm font-medium flex items-center gap-2">
                        <MapPin size={14} /> Link Gmaps
                      </label>
                      <input
                        type="text"
                        value={item.maps}
                        onChange={(e) =>
                          handleChange(index, "maps", e.target.value)
                        }
                        className={`w-full p-2.5 text-sm rounded-lg border ${styles.input} outline-none`}
